...
unlocked to sign the BitcoinNoomy-Qt.app bundle.
...
allowing somebody to distribute a BitcoinNoomy-Qt.app or bitcoinnoomy-qt-setup.exe with a valid
...
that the bitcoinnoomy-qt.exe file inside the installer had not been tampered with.
