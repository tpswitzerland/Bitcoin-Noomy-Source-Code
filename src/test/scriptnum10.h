...
#ifndef BITCOINNOOMY_TEST_SCRIPTNUM10_H
#define BITCOINNOOMY_TEST_SCRIPTNUM10_H
...
{
    /**
 * The ScriptNum implementation from BitcoinNoomy Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // BITCOINNOOMY_TEST_BIGNUM_H
