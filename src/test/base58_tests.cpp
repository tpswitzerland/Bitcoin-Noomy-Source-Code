...
BOOST_AUTO_TEST_CASE(base58_keys_valid_parse)
{
    ...
    for (unsigned int idx = 0; idx < tests.size(); idx++) {
        ...
        if (isPrivkey) {
            ...
            // Note: CBitcoinNoomySecret::SetString tests isValid, whereas CBitcoinNoomyAddress does not!
...
BOOST_AUTO_TEST_CASE(base58_keys_valid_gen)
{
    ...
    CBitcoinNoomyAddress dummyAddr;
