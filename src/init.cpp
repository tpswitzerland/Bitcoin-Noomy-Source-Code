 ...
 * between bitcoinnoomyd, and bitcoinnoomy-qt and non-server tools.
*/
...
void Shutdown()
{
    ...
    RenameThread("bitcoinnoomy-shutoff");
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), BITCOINNOOMY_PID_FILENAME));
#endif
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/bitcoinnoomy/bitcoinnoomy>";
    const std::string URL_WEBSITE = "<https://bitcoinnoomycore.org>";
...
void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("bitcoinnoomy-loadblk");
...
/** Sanity checks
 *  Ensure that BitcoinNoomy is running in a usable environment with all
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("BitcoinNoomy version %s\n", FormatFullVersion());
}
...
bool AppInitParameterInteraction()
{
    ...
    if (gArgs.GetBoolArg("-disablefork", false)) {
        printf("NOTE: disabling fork; this node will run on the bitcoinnoomy network\n");
        FORK_ALLOWED = false;
...
static bool LockDataDirectory(bool probeOnly)
{
    ...
    // Make sure only a single BitcoinNoomy process is using the data directory.
...
// ********************************************************* Step 4a: application initialization
    ...
    LogPrintf("Using config file %s\n", GetConfigFile(gArgs.GetArg("-conf", BITCOINNOOMY_CONF_FILENAME)).string());
