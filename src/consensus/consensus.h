...
#ifndef BITCOINNOOMY_CONSENSUS_CONSENSUS_H
#define BITCOINNOOMY_CONSENSUS_CONSENSUS_H
...
// version. The former uses BitcoinNoomy parameters, but if this fork is a fork
...
#endif // BITCOINNOOMY_CONSENSUS_CONSENSUS_H
