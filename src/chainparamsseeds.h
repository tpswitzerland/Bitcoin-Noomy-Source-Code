#ifndef BITCOINNOOMY_CHAINPARAMSSEEDS_H
#define BITCOINNOOMY_CHAINPARAMSSEEDS_H
/**
 * List of fixed seed nodes for the bitcoinnoomy network
...
#endif // BITCOINNOOMY_CHAINPARAMSSEEDS_H
