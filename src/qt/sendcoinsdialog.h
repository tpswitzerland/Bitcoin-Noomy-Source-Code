...
#ifndef BITCOINNOOMY_QT_SENDCOINSDIALOG_H
#define BITCOINNOOMY_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending bitcoinnoomys */
...
#endif // BITCOINNOOMY_QT_SENDCOINSDIALOG_H
