...
#ifndef BITCOINNOOMY_WALLET_WALLET_H
#define BITCOINNOOMY_WALLET_WALLET_H
...
public:
     ...
     * on this bitcoinnoomy node, and set to 0 for transactions that were created
...
#endif // BITCOINNOOMY_WALLET_WALLET_H
