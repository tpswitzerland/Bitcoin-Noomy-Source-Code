...
from test_framework.test_framework import BitcoinNoomyTestFramework, SkipTest
from test_framework.util import (assert_equal,
                                 bytes_to_hex_str,
                                 hash256,
                                )

class ZMQTest (BitcoinNoomyTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that bitcoinnoomy has been built with ZMQ enabled
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("bitcoinnoomyd has not been built with zmq enabled.")
