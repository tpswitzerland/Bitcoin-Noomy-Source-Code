...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BitcoinNoomyTestFramework
    pass

class ExampleTest(BitcoinNoomyTestFramework):
    # Each functional test is a subclass of the BitcoinNoomyTestFramework class.
    ...
    def custom_method(self):
        ...
        BitcoinNoomyTestFramework class so other tests can use it."""
