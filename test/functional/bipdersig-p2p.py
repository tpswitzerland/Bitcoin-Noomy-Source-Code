...
class BIP66Test(BitcoinNoomyTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # bitcoinnoomyd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and bitcoinnoomyd produces more specific reject
            # reasons.
