...
This document provides guidelines for internationalization of the BitcoinNoomy Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitcoinnoomy_en.ts` remains unchanged.
