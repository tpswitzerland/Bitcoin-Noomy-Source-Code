BitcoinNoomy version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcoinnoomy/files/BitcoinNoomy/bitcoinnoomy-0.5.4/
...
http://gitorious.org/bitcoinnoomy/bitcoinnoomyd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix BitcoinNoomy-Qt notifications under Growl 1.3.
Increase required age of BitcoinNoomy-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoinNoomy properly when installing BitcoinNoomy-Qt over it. (Windows)
