BitcoinNoomy Core version 0.10.4 is now available from:

  <https://bitcoinnoomy.org/bin/bitcoinnoomy-core-0.10.4/>
...
- #6953 `43c2789` Split bitcoinnoomy-tx into its own package
- #6953 `dfe0d4d` Include bitcoinnoomy-tx binary on Debian/Ubuntu
