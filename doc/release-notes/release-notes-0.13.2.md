BitcoinNoomy Core version 0.13.2 is now available from:

  <https://bitcoinnoomy.org/bin/bitcoinnoomy-core-0.13.2/>
...
- #8908 `4a974b2` Update bitcoinnoomy-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bitcoinnoomy-tx to create v2 transactions (btcdrak)
