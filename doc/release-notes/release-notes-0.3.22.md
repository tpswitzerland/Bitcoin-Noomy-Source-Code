Download URL: https://sourceforge.net/projects/bitcoinnoomy/files/BitcoinNoomy/bitcoinnoomy-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 BNY fee schedule (users still pay 0.01 BNY per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #bitcoinnoomy00 - #bitcoinnoomy99
