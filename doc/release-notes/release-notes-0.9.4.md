BitcoinNoomy Core version 0.9.4 is now available from:

  https://bitcoinnoomy.org/bin/0.9.4/
...
this update is incompatible with the BitcoinNoomy system and could lead to consensus
forks.

BitcoinNoomy Core released binaries from https://bitcoinnoomy.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitcoinnoomy/+archive/ubuntu/bitcoinnoomy
- A third-party or self-compiled BitcoinNoomy Core

upgrade to BitcoinNoomy Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
