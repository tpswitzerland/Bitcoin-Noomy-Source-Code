BitcoinNoomy-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bitcoinnoomy/files/BitcoinNoomy/bitcoinnoomy-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the BitcoinNoomy
...
New/changed settings (command-line or bitcoinnoomy.conf file)
--------------------------------------------------------
