BitcoinNoomy Core version 0.10.3 is now available from:

  <https://bitcoinnoomy.org/bin/bitcoinnoomy-core-0.10.3/>
...
(see https://github.com/bitcoinnoomy/bitcoinnoomy/pull/6793, as well as the 0.11.0
