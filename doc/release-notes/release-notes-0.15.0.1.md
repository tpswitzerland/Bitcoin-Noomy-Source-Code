BitcoinNoomy Core version *0.15.0.1* is now available from:

  <https://bitcoinnoomy.org/bin/bitcoinnoomy-core-0.15.0.1/>

and

  <https://bitcoinnoomycore.org/bin/bitcoinnoomy-core-0.15.0.1/>
