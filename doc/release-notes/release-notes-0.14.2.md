BitcoinNoomy Core version 0.14.2 is now available from:

  <https://bitcoinnoomy.org/bin/bitcoinnoomy-core-0.14.2/>
...
(in BitcoinNoomy Core 0.10.3) it has been disabled by default.
...
Since 0.14.0 the approximate transaction fee shown in BitcoinNoomy-Qt when using coin
...
- #10228 `ae479bc` Regenerate bitcoinnoomy-config.h as necessary (theuni)
