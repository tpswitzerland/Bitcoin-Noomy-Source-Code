BitcoinNoomy Core version 0.9.2.1 is now available from:

  https://bitcoinnoomy.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 BNY to 0.01 BNY
...
- Fix "Start bitcoinnoomy on system login"
